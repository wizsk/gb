...
// name mane file name
func OpenEncrypted(c *config.Config, filename string, tmpFile *string) error {
	// create the tmp dir
...
func CreateNewFile(c *config.Config, fileName string, tmpFile *string) error {
